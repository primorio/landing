...
import CalendlyWidget from "./_CalendlyWidget";
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
                Unser KI-Concierge nimmt Anrufe 24/7 entgegen, erfasst alle
                relevanten Informationen professionell und leitet sie
                strukturiert per E-Mail an Sie weiter.{" "}
              ...
              <div className="mb-12 mt-24">
                <div className="text-center mb-4">
                  ...
                  <p className="text-lg text-gray-600 mb-6">
                    Rufen Sie an und erleben Sie unseren KI-Concierge live in
                    Aktion
                  </p>
                </div>
                ...
                <div className="flex items-center justify-center text-gray-500 text-sm mb-8">
                  ...
                  <span>Tipp: Melden Sie eine fiktive, kaputte Heizung</span>
                </div>
              </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-gray-600 mb-8">
                  Der Alltag in der Hausverwaltung ist geprägt von ständigen
                  Unterbrechungen...
                </p>
              </div>
              ...
              <div className="text-center">
                <p className="text-xl text-gray-700 font-medium">
                  <strong>Das muss nicht so sein.</strong> Es gibt eine bessere
                  Lösung...
                </p>
              </div>
            </div>
        ...
        <section id="solution-section" className="py-16 bg-green-50">
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="text-4xl font-bold text-gray-900 mb-6">
                  <span className="text-green-700">Hier ist die Lösung:</span>{" "}
                  Ihr KI-Telefon-Concierge
                </h2>
                <p className="text-xl text-gray-600 mb-8">
                  Von der Anrufannahme bis zur strukturierten Weiterleitung –
                  vollautomatisch und professionell
                </p>
              </div>
              ...
              <div className="text-center">
                <div className="bg-white rounded-2xl shadow-xl border border-green-200 p-8 max-w-2xl mx-auto hover:shadow-2xl transition-all duration-300">
                  ...
                  <p className="text-gray-600 mb-6">
                    Rufen Sie unseren KI-Concierge an und testen Sie die
                    Gesprächsqualität live.
                  </p>
        ...
        <section id="benefits-section" className="py-16 bg-blue-50">
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="text-4xl font-bold text-gray-900 mb-6">
                  <span className="text-blue-700">Das Ergebnis:</span> Ihre
                  Vorteile auf einen Blick
                </h2>
                <p className="text-xl text-gray-600">
                  Verwandeln Sie Ihre größten Herausforderungen in Ihre
                  stärksten Vorteile
                </p>
              </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="text-4xl font-bold text-gray-900 mb-6">
                  So läuft ein{" "}
                  <span className="text-teal-600">echtes Telefongespräch</span>{" "}
                  ab
                </h2>
                <p className="text-xl text-gray-600">
                  Sehen Sie selbst, wie professionell unser KI-Concierge
                  arbeitet und welche E-Mail Sie erhalten
                </p>
              </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="bg-teal-50 rounded-2xl rounded-tl-sm p-4 max-w-sm relative">
                      ...
                      <p className="text-sm text-gray-800">
                        Vielen Dank für Ihren Anruf bei der
                        Musterhausverwaltung. Gerade ist kein menschlicher
                        Mitarbeiter verfügbar, deshalb wurden sie an mich, den
                        digitalen Assistenten, weitergeleitet. Womit kann ich
                  ...
                  <div className="flex items-start space-x-3 justify-end">
                    <div className="bg-gray-100 rounded-2xl rounded-tr-sm p-4 max-w-sm relative">
                      ...
                      <p className="text-sm text-gray-800">
                        Hallo, ich habe einen Wasserschaden in meiner Wohnung im
                        Badezimmer. Hier ist alles nass!
                      </p>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="bg-teal-50 rounded-2xl rounded-tl-sm p-4 max-w-sm relative">
                      <div className="absolute -left-1 top-3 w-2 h-2 bg-teal-50 rotate-45"></div>
                      <p className="text-sm text-gray-800">
                        Das tut mir leid zu hören. Ich erfasse das sofort für
                        Sie. Ich benötige noch ein paar Informationen von Ihnen.
                        Wie ist Ihre genaue Adresse und wie lange ist der
                        Schaden schon angefallen?
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3 justify-end">
                    <div className="bg-gray-100 rounded-2xl rounded-tr-sm p-4 max-w-sm relative">
                      <div className="absolute -right-1 top-3 w-2 h-2 bg-gray-100 rotate-45"></div>
                      <p className="text-sm text-gray-800">
                        Ich bin Maria Schmidt, Wohnung 3B in der Musterstraße
                        15. Seit heute morgen tropft hier Wasser aus der Decke.
                      </p>
                    </div>
                    <div className="w-10 h-10 bg-gray-300 rounded-full flex items-center justify-center flex-shrink-0 relative">
                      <User className="w-5 h-5 text-gray-600" />
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="bg-teal-50 rounded-2xl rounded-tl-sm p-4 max-w-sm relative">
                      <div className="absolute -left-1 top-3 w-2 h-2 bg-teal-50 rotate-45"></div>
                      <p className="text-sm text-gray-800">
                        Verstanden. Ich habe alle wichtigen Informationen
                        erfasst. Die Schadensmeldung wird sofort an die
                        Hausverwaltung weitergeleitet. Bis wann sind Sie noch
                        erreichbar?
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3 justify-end">
                    <div className="bg-gray-100 rounded-2xl rounded-tr-sm p-4 max-w-sm relative">
                      <div className="absolute -right-1 top-3 w-2 h-2 bg-gray-100 rotate-45"></div>
                      <p className="text-sm text-gray-800">
                        Bis 18 Uhr bin ich unter dieser Nummer erreichbar.
                        Vielen Dank!
                      </p>
                    </div>
                    <div className="w-10 h-10 bg-gray-300 rounded-full flex items-center justify-center flex-shrink-0 relative">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="bg-teal-50 rounded-2xl rounded-tl-sm p-4 max-w-sm relative">
                      <div className="absolute -left-1 top-3 w-2 h-2 bg-teal-50 rotate-45"></div>
                      <p className="text-sm text-gray-800">
                        Perfekt! Alles ist erfasst und wird sofort
                        weitergeleitet. Die Hausverwaltung wird sich bei Ihnen
                        ...
                        <div className="space-y-4">
                          <div className="border-b border-gray-100 pb-3">
                            <p className="text-sm text-gray-600">
                              Von: concierge@primorio.de
                            </p>
                            <p className="text-sm text-gray-600">
                              An: verwaltung@mueller-hausverwaltung.de
                            </p>
                            <p className="text-sm text-gray-600">
                              Betreff:{" "}
                              <strong>
                                WASSERSCHADEN - Musterstraße 15, Wohnung 3B
                              </strong>
                            </p>
                          </div>
                          ...
                          <div className="space-y-3">
                            ...
                            <div>
                              ...
                              <p className="text-gray-900 mt-1">
                                <strong>Wasserschaden im Badezimmer</strong> -
                                Wasser tropft kontinuierlich von der Decke (seit
                                heute morgen)
                              </p>
                            </div>
                            ...
                            <div className="text-xs text-gray-500 pt-2 border-t border-gray-100">
                              <p>
                                Automatisch generiert durch Primorio Concierge •
                                Gespräch: 2:34 Min •{" "}
              ...
              <div className="text-center mt-12">
                <div className="inline-flex items-center px-6 py-3 bg-teal-100 text-teal-800 rounded-full">
                  ...
                  <span className="font-medium">
                    Vollständig • Strukturiert • Priorität erkannt • Sofort
                    verfügbar
                  </span>
                </div>
              </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center text-white">
              ...
              <p className="text-xl mb-8 opacity-90">
                Testen Sie unseren KI-Concierge jetzt kostenlos oder fordern Sie
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-8">
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 hover:bg-white/15 transition-all duration-300">
                  ...
                  <p className="text-white/80 mb-6">
                    Individuelle Lösung für Ihre Hausverwaltung
                  </p>
                  <ul className="text-sm text-white/80 mb-6 space-y-1">
                    <li className="flex items-center">
                      <CheckCircle className="w-4 h-4 mr-2" /> Kostenlose
                      Beratung
                    </li>
                    <li className="flex items-center">
                      <CheckCircle className="w-4 h-4 mr-2" /> Maßgeschneiderte
                      Lösung
                    </li>
                    <li className="flex items-center">
                      <CheckCircle className="w-4 h-4 mr-2" /> Schnelle
                      Umsetzung
                    </li>
                  </ul>
                  <ScrollToButton
              ...
              <p className="text-white/70 text-sm">
                Kostenloser Test • Keine Verpflichtung • DSGVO-konform
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-gray-600">
                  Unser KI-Concierge beherrscht alle wichtigen Szenarien der
                  Hausverwaltung
                </p>
              </div>
              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                  <h2 className="text-3xl font-bold text-gray-900 mb-6">
                    Vertrauen Sie auf Sicherheit und Datenschutz
                  </h2>
                  <div className="space-y-4">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm">
                          Alle Daten werden nach deutschen Datenschutzstandards
                          verarbeitet
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm">
                          Verschlüsselte Kommunikation und sichere
