    ...
    return (
        <Card className="max-w-lg w-full">
            <CardContent className="p-8">
                <h1 className="text-3xl font-bold mb-4 text-gray-900">Kontakt</h1>
                ...
                {success ? (
                    <div className="flex flex-col items-center justify-center text-green-700 py-8">
                        ...
                        <div className="font-semibold text-xl text-center">Vielen Dank für Ihre Nachricht!<br />Wir melden uns zeitnah.</div>
                    </div>
                ) : (
